...
QT_MOC_LITERAL(3, 22, 25)
    ...
    "Filters\0appyGaussian\0\0on_gaussianButton_clicked\0"
};
...
void Filters::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: { bool _r = _t->appyGaussian();
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;
        case 1: _t->on_gaussianButton_clicked(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Filters::appyGaussian)) {
                *result = 0;
            }
        }
    }
